...
`/admin/parts`의 **컴퓨존 가격 갱신** 버튼. 지금 목록(검색·분류 필터 결과) 중 컴퓨존
링크가 있는 부품의 현재가를 읽어 단가를 맞춘다. 대표 요청이 주 1~2회 일괄 갱신이라
상시 배치 대신 눌러서 도는 방식으로 뒀다.
...
실측(2026-08-24, 6건 표본): 가격 변동 4건(9700X 379,000→415,000 / 9850X3D 749,510→721,000 /
B550M 127,270→123,000 / B650M-A 169,000→164,000), 단종 2건, 실패 0.
**단가가 실제로 상당히 낡아 있다** — 첫 전체 갱신은 변동 폭을 한 번 훑어보고 반영할 것.
